...
import { createNpcManager } from "../inkwell/NPC.js?v=28";
import { createStoryNpcManager } from "../inkwell/StoryNPC.js?v=5";
...
import { createSubMapScene } from "../ecology/SubMapScene.js?v=5";
